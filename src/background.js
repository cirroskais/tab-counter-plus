...
async function startup() {
    ...
    // Send tab details every 5 seconds
    setInterval(track, 1000 * 5);
}
...
async function track() {
    const prefs = await browser.storage.local.get(["trackingEnabled", "trackingUrl", "trackingKey"]);
        ...
        try {
            ...
            await fetch(url, {
                ...
                headers: {
                    ...
                    Authorization: prefs.trackingKey,
                },
                body: JSON.stringify({
                    tabs: allTabs.length,
